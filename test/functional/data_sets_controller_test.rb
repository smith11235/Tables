...
class DataSetsControllerTest < ActionController::TestCase
  ...
  test "should create data_set" do
    assert_difference('DataSet.count') do
      post :create, data_set: { checksum: @data_set.checksum, name: @data_set.name, parameters: @data_set.parameters, source: @data_set.source }
    end
  ...
  test "should update data_set" do
    put :update, id: @data_set, data_set: { checksum: @data_set.checksum, name: @data_set.name, parameters: @data_set.parameters, source: @data_set.source }
    assert_redirected_to data_set_path(assigns(:data_set))
  end
