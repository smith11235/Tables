...
class CellsControllerTest < ActionController::TestCase
  ...
  test "should create cell" do
    assert_difference('Cell.count') do
      post :create, cell: { datetime: @cell.datetime, float: @cell.float, int: @cell.int, string: @cell.string }
    end
  ...
  test "should update cell" do
    put :update, id: @cell, cell: { datetime: @cell.datetime, float: @cell.float, int: @cell.int, string: @cell.string }
    assert_redirected_to cell_path(assigns(:cell))
  end
